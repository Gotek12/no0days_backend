...
const msgs = {
  ...
  getUsersBad:
    ...
    'was unsuccessful.',
  addUserSuccess: 'should return a status code of ' + `"${HttpStatusCodes.CREATED}" if the request was successful.`,
  ...
  addUserFallbackErr:
    ...
    `and a status code of "${HttpStatusCodes.BAD_REQUEST}" if the request ` +
    'was unsuccessful.',
  updateSuccess: `should return a status code of "${HttpStatusCodes.OK}" if ` + 'the request was successful.',
  updateParamMissing:
    'should return a JSON object with an error message ' +
  ...
  updateFallbackErr:
    ...
    `and a status code of "${HttpStatusCodes.BAD_REQUEST}" if the request ` +
    'was unsuccessful.',
  deleteSuccessful: `should return a status code of "${HttpStatusCodes.OK}" ` + 'if the request was successful.',
  deleteUserNotFound:
    'should return a JSON object with the error message ' +
    `of "${userNotFoundErr}" and a status code of ` +
    `"${HttpStatusCodes.NOT_FOUND}" if the id was not found.`,
...
describe('user-router', () => {
  ...
  describe(`"PUT:${updateUserPath}"`, () => {
    const callApi = (reqBody: TReqBody) =>
      agent.put(updateUserPath).set('Cookie', jwtCookie).type('form').send(reqBody);
